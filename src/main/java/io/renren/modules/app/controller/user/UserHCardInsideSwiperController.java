...
import io.renren.modules.app.service.UserHCardInsideSwiperService;
 ...
 */
@RestController
@RequestMapping("/api/user/hCardInsideSwiper")
public class UserHCardInsideSwiperController extends BaseController {
	@Autowired
	UserHCardInsideSwiperService swiperService;
	...
	public Result<?> list(){
    	...
    	try {
    		List<HCardInsideSwiperPO> list=swiperService.list();
