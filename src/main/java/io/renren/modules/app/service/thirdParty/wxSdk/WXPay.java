...
import io.renren.modules.app.service.thirdParty.wxSdk.WXPayConstants.SignType;
import lombok.Data;
...
public class WXPay {
    ...
    public Map<String, String> downloadfundflow(Map<String, String> reqData) throws Exception {
        return this.downloadfundflow(reqData, config.getHttpConnectTimeoutMs(), this.config.getHttpReadTimeoutMs());
    }
